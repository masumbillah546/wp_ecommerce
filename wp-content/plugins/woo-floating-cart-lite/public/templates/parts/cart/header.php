...
<div class="xt_woofc-header">
	...
	<?php if ( xt_woofc_option_bool( 'enable_coupon_form', false ) ) : ?>
        ...
        <a class="xt_woofc-show-coupon"
           href="#0"><?php echo apply_filters( 'xt_woofc_lang_header_have_coupon', esc_html__( 'Have a coupon ?', 'woo-floating-cart' ) ); ?></a>
    </span>
	<?php endif; ?>

    <?php if( xt_woofc_option_bool('cart_header_close_enabled', false)) : ?>
    <span class="<?php echo xt_woofc_header_close_icon_class(); ?>"></span>
    <?php endif; ?>
