...
$fields[] = array(
    'id'       => 'shop',
    'section'  => 'default',
    'label'    => esc_html__( 'Shop / Archive Page', 'xt-framework' ),
    'type'     => 'custom'
);
...
$fields[] = array(
    'id'       => 'single',
    'section'  => 'default',
    'label'    => esc_html__( 'Single Product Page', 'xt-framework' ),
    'type'     => 'custom'
);
...
$fields[] = array(
    'id'       => 'spinner',
    'section'  => 'default',
    'label'    => esc_html__( 'Spinner Settings', 'xt-framework' ),
    'type'     => 'custom'
);
...
$fields[] = array(
    'id'       => 'redirections',
    'section'  => 'default',
    'label'    => esc_html__( 'Redirection Settings', 'xt-framework' ),
    'type'     => 'custom'
);
