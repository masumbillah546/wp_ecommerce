                        ...
                        <tbody>
                            <tr>
                                <th class="text-center" scope="row">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/product/2.jpg" alt="img">
                                </th>
                            ...
                            <tr>
                                <th class="text-center" scope="row">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/product/4.jpg" alt="img">
                                </th>
                                <td class="text-center">
                            ...
                            <tr>
                                <th class="text-center" scope="row">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/product/6.jpg" alt="img">
