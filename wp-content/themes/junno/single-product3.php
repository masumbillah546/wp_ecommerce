        ...
        <div class="row">
            <div class="col-lg-6 mb-5 mb-lg-0">
                ...
                <div class="product-sync-init mb-20">
                    <div class="single-product">
                        <div class="product-thumb">
                            <img src="<?php echo get_template_directory_uri();?>/assets/img/single-product/1.jpg" alt="product-thumb">
                        </div>
                    </div>
                    <!-- single-product end -->
                    <div class="single-product">
                        <div class="product-thumb">
                            <img src="<?php echo get_template_directory_uri();?>/assets/img/single-product/2.jpg" alt="product-thumb">
                        </div>
                    </div>
                    <!-- single-product end -->
                    <div class="single-product">
                        <div class="product-thumb">
                            <img src="<?php echo get_template_directory_uri();?>/assets/img/single-product/3.jpg" alt="product-thumb">
                        </div>
                    </div>
                    <!-- single-product end -->
                    <div class="single-product">
                        <div class="product-thumb">
                            <img src="<?php echo get_template_directory_uri();?>/assets/img/single-product/4.jpg" alt="product-thumb">
                        </div>
                    </div>
                    <!-- single-product end -->
                </div>
                ...
                <div class="product-sync-nav single-product">
                    <div class="single-product">
                        <div class="product-thumb">
                            <a href="javascript:void(0)"> <img src="<?php echo get_template_directory_uri();?>/assets/img/single-product/1.2x.jpg"
                                    alt="product-thumb"></a>
                        </div>
                    </div>
                    <!-- single-product end -->
                    <div class="single-product">
                        <div class="product-thumb">
                            <a href="javascript:void(0)"> <img src="<?php echo get_template_directory_uri();?>/assets/img/single-product/2.2x.jpg"
                                    alt="product-thumb"></a>
                        </div>
                    </div>
                    <!-- single-product end -->
                    <div class="single-product">
                        <div class="product-thumb">
                            <a href="javascript:void(0)"><img src="<?php echo get_template_directory_uri();?>/assets/img/single-product/3.2x.jpg"
                                    alt="product-thumb"></a>
                        </div>
                    </div>
                    <!-- single-product end -->
                    <div class="single-product">
                        <div class="product-thumb">
                            <a href="javascript:void(0)"><img src="<?php echo get_template_directory_uri();?>/assets/img/single-product/4.2x.jpg"
                                    alt="product-thumb"></a>
                        </div>
                    </div>
                    <!-- single-product end -->
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="single-product-desc">
                            <div class="studio-thumb">
                                <a href="#"><img class="mb-30" src="<?php echo get_template_directory_uri();?>/assets/img/stodio.jpg" alt="studio-thumb"></a>
                                ...
                                <div class="media flex-column">
                                    <div class="product-thumbnail position-relative">
                                        ...
                                        <a href="single-product.html">
                                            <img class="first-img" src="<?php echo get_template_directory_uri();?>/assets/img/new-products/1.jpg" alt="thumbnail">
                                            <img class="second-img" src="<?php echo get_template_directory_uri();?>/assets/img/new-products/1.1.jpg"
                                                alt="thumbnail">
                                        </a>
                                        <!-- product links -->
                            ...
                            <div class="card-body p-0">
                                <div class="media flex-column">
                                    <div class="product-thumbnail position-relative">
                                        <span class="badge badge-danger top-right">New</span>
                                        <a href="single-product.html">
                                            <img class="first-img" src="<?php echo get_template_directory_uri();?>/assets/img/new-products/2.jpg" alt="thumbnail">
                                        </a>
                                        <!-- product links -->
                                        <ul class="product-links d-flex justify-content-center">
                                            <li>
                            ...
                            <div class="card-body p-0">
                                <div class="media flex-column">
                                    <div class="product-thumbnail position-relative">
                                        ...
                                        <span class="badge badge-danger top-right">New</span>
                                        <a href="single-product.html">
                                            <img class="first-img" src="<?php echo get_template_directory_uri();?>/assets/img/new-products/3.jpg" alt="thumbnail">
                                        </a>
                                        <!-- product links -->
                                        <ul class="product-links d-flex justify-content-center">
                                            <li>
                            ...
                            <div class="card-body p-0">
                                <div class="media flex-column">
                                    <div class="product-thumbnail position-relative">
                                        <span class="badge badge-danger top-right">New</span>
                                        <a href="single-product.html">
                                            <img class="first-img" src="<?php echo get_template_directory_uri();?>/assets/img/new-products/4.jpg" alt="thumbnail">
                                            <img class="second-img" src="<?php echo get_template_directory_uri();?>/assets/img/new-products/4.1.jpg"
                                                alt="thumbnail">
                                        </a>
                                        <!-- product links -->
                                        <ul class="product-links d-flex justify-content-center">
                            ...
                            <div class="card-body p-0">
                                <div class="media flex-column">
                                    <div class="product-thumbnail position-relative">
                                        <span class="badge badge-danger top-right">New</span>
                                        <a href="single-product.html">
                                            <img class="first-img" src="<?php echo get_template_directory_uri();?>/assets/img/new-products/5.jpg" alt="thumbnail">
                                        </a>
                                        <!-- product links -->
                                        <ul class="product-links d-flex justify-content-center">
                                            <li>
                            ...
                            <div class="card-body p-0">
                                <div class="media flex-column">
                                    <div class="product-thumbnail position-relative">
                                        <span class="badge badge-danger top-right">New</span>
                                        <a href="single-product.html">
                                            <img class="first-img" src="<?php echo get_template_directory_uri();?>/assets/img/new-products/6.jpg" alt="thumbnail">
                                        </a>
                                        <!-- product links -->
                                        <ul class="product-links d-flex justify-content-center">
                                            <li>
