        ...
        <div class="row">
                            ...
                            <div class="card-body">
                                <div class="checkout-inner border-0">
                                    ...
                                    <div class="check-out-content">
                                        <form id="contact-form" class="p-0" action="<?php echo get_template_directory_uri();?>/assets/php/mail.php" method="post">
                                            <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-11 delivery-option-2">
                                                            <div class="row align-items-center">
                                                                <div class="col-sm-5 col-12">
                                                                    <div class="row align-items-center">
                                                                        <div class="col-3">
                                                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/10.jpg"
                                                                                alt="My carrier">
                                                                        </div>
                                                                        <div class="col-9">
            ...
            <div class="col-lg-4 mb-30">
                ...
                <div class="delivery-info mt-20">
                    <ul>
                        <li>
                            <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/10.png" alt="icon"> Security policy (edit with Customer
                            reassurance module)
                        </li>
                        <li>
                            <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/11.png" alt="icon"> Delivery policy (edit with Customer
                            reassurance module)
                        </li>
                        <li class="mb-0">
                            <img src="<?php echo get_template_directory_uri();?>/assets/img/icon/12.png" alt="icon"> Return policy (edit with Customer
                            reassurance module)
                        </li>
                    </ul>
                </div>
